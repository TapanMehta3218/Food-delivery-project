...
function SignIn() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      setErr(error?.response?.data?.message || error?.message || "An unexpected error occurred");
      setLoading(false);
    }
  };
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      console.error(error);
      setErr(error?.response?.data?.message || error?.message || "Google authentication failed");
    }
  };
  return (
    <div
